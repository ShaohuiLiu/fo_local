...
% 17. damping coefficient d_o(pu),
% 18. dampling coefficient d_1(pu),
mac_con(:,17) = 1 .* mac_con(:,16); % uniform, proportional to inertia in p.u.
% mac_con(:,18) = 0.2 .* mac_con(:,16); % uniform
...
% 1.0  0    0    0    0    0   0.01; % increase time step (0.02 not stable, 50 < 60hz)
% 15.0  0    0    0    0    0    0]; % end simulation

% without fault
% sw_con = [...
% 0    0    0    0    0    0    0.01;%sets intitial time step
% 0.1  29    28    0    0    6    0.01; %no fault at bus 29, on line 29-28
% 0.15 0    0    0    0    0    0.01; %clear fault at bus 
...
sw_con = [...
0    0    0    0    0    0    0.01;%sets intitial time step
0.1  29    28    0    0    6    0.005; %no fault at bus 29, on line 29-28
0.15 0    0    0    0    0    0.005; %clear fault at bus 
0.20 0    0    0    0    0    0.005; %clear remote end
0.50 0    0    0    0    0    0.01; % increase time step 
1.0  0    0    0    0    0   0.01; % increase time step (0.02 not stable, 50 < 60hz)
